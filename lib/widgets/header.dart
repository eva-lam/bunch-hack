...
import 'package:bunch/utils/my_platform.dart';
...
class _HeaderWidgetState extends State<HeaderWidget> {
  var links = ["Home", "Resources", "Videos", "Podcasts"];
  ...
  Widget buildHeaderLinks(BuildContext context) {
    if (!ResponsiveWidget.isSmallScreen(context)) {
      ...
      return PopupMenuButton(
        ...
        child: Image.asset("assets/menu.png", width: 35, height: 35),
        ...
        itemBuilder: (BuildContext context) => <PopupMenuEntry<NavLinks>>[
          ...
          const PopupMenuItem(value: NavLinks.Resources, child: Text("Resources")),
          const PopupMenuItem(value: NavLinks.Videos, child: Text("Videos")),
          const PopupMenuItem(value: NavLinks.Podcasts, child: Text("Podcast")),
        ],
      );
    }
  }
  ...
  String getTargetUrl(NavLinks link) {
    ...
    switch (link) {
      ...
      case NavLinks.Podcasts:
        url = "https://www.manager-tools.com/podcasts";
        break;
